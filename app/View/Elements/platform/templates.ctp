...
<ul class="originUI-list">
	...
	<li>
		...
		<li>
			<label>Ad Type</label>
			<select class="originUI-select originUI-bgColorSecondary" data-ng-model="editor.config.type" data-ng-change="templateSelect('editor', editor.config.type)">
		...
		<li>
			...
			<select class="originUI-select originUI-bgColorSecondary" ng:model="editor.config.placement">
