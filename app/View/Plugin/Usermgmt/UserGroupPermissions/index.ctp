...
<div id="system-config" class="" ng:controller="originSystems">
	<h2 class="originUI-header"><a href="/administrator/settings" class="originUI-back originUI-hover">System Configuration</a></h2>
	...
	--><div id="systemConfig-access" class="originUI-tileRight originUI-bgColor originUI-shadow" data-intro="Manage system access" data-position="top">
		...
		<?php 
			echo $this->Form->input('controller', array('type'=>'select','div'=>array('id'=>'systemConfig-select', 'class'=>'originUI-field'), 'options'=>$allControllers, 'selected'=>$c, 'label'=>false, 'onchange'=>"window.location='".SITE_URL."administrator/settings/access/?c='+(this).value", 'class'=>'originUI-select originUI-bgColorSecondary'));
		?>
