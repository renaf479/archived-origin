...
<div id="user-list" class="" ng:controller="usersController">	
	...
	<form id="user-create" name="userCreateForm" class="originUI-tileLeft originUI-bgColorSecondary originUI-shadow" novalidate>
		...
		<div class="originUI-tileFooter">
			<button class="originUI-tileFooterCenter originUI-hover" ng:click="userCreate()" ng-disabled="userCreateForm.$invalid">Create</button>
		</div>
	</form><!--
	...
	<div modal="originModal" close="userClose()" options="{backdropClick: false, backdropFade: true}">
		<form id="user-edit" name="user-edit" class="originUI-bgColorSecondary originUI-modal">
			...
			<a href="javascript:void(0)" class="originUI-modalRemove originUI-hover" ng:click="userRemove()">remove</a>
