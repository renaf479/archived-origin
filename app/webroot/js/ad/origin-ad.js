	...
	var response = {
		...
		adInit: function(data) {
			...
			switch(data.config.placement) {
				default:
				case 'default':
					originAd.height	= data.config.height + 'px';
					originAd.width	= data.config.width + 'px';
					break;
				case 'top':
					originAd.height	= data.config.height + 'px';
					originAd.width	= '100%';
...
*/
		...
		toggleexpand: function(data) {
			...
			switch(data.placement) {
				default:
				case 'default':
					anim(expand, {height:data.resizeHeight,width:data.resizeWidth}, data.duration, 'ease-out');
					break;
				case 'top':
